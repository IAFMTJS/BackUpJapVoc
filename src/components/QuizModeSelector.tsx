...
const QuizModeSelector: React.FC<QuizModeSelectorProps> = ({
  ...
  return (
    <div className={`flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 p-2 sm:p-4 rounded-xl ${themeClasses.card} border ${themeClasses.border} ${
      ...
      {availableModes.map((mode) => (
        <button
          ...
          className={`w-full sm:w-auto px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg transition-all duration-300 font-medium text-sm sm:text-base ${
            selectedMode === mode
